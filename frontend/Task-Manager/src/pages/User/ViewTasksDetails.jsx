  ...
  if (todoCheckList && todoCheckList[index]) {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        // Reverte a alteração se a chamada API falhar
        todoCheckList[index].completed = !todoCheckList[index].completed;
      }
    } catch (error) {
...
const Attachment = ({ link, index, onClick }) => {
  return (
    <div 
      className="flex justify-between bg-gray-50 border border-gray-100 px-3 py-2 rounded-mb mb-3 mt-2 cursor-pointer"
      onClick={onClick}
    >
